...
// config stores all the available configuration items. If an item is
// documented here it is because it currently has no public Opt* func;
// otherwise the documentation will be at the corresponding Opt* func.
type config struct {
	...
	messageTimeout     int
	// tombstoneDiscardInterval indicates the minimum number of seconds
	// betweeen the starts of discard passes (discarding expired tombstones
	// [deletion markers]).Defaults to env VALUESTORE_TOMBSTONEDISCARDINTERVAL
	// or VALUESTORE_BACKGROUNDINTERVAL.
	...
	// again. Defaults to env VALUESTORE_TOMBSTONEDISCARDBATCHSIZE or
	// 1,048,576.
	...
	// env VALUESTORE_INPULLREPLICATIONMSGS or VALUESTORE_WORKERS*4.
	inPullReplicationMsgs int
	// inPullReplicationHandlers indicates how many incoming pull-replication
	// messages can be processed at the same time. Defaults to env
	// VALUESTORE_INPULLREPLICATIONHANDLERS or VALUESTORE_WORKERS.
	...
	// Defaults to env VALUESTORE_INPULLREPLICATIONMSGTIMEOUT or
	// VALUESTORE_MESSAGETIMEOUT.
	...
	// outPullReplicationInterval indicates the minimum number of seconds
	// between the starts of outgoing pull replication passes. Defaults to env
	// VALUESTORE_OUTPULLREPLICATIONINTERVAL or VALUESTORE_BACKGROUNDINTERVAL.
	...
	// env VALUESTORE_OUTPULLREPLICATIONMSGS or VALUESTORE_WORKERS*4.
	...
	// affects memory usage. Defaults to env
	// VALUESTORE_OUTPULLREPLICATIONBLOOMN or 1000000.
	...
	// the N-factor, affects memory usage. Defaults to env
	...
	// outPushReplicationInterval indicates the minimum number of seconds
	// between the starts of outgoing push replication passes. Defaults to env
	// VALUESTORE_OUTPUSHREPLICATIONINTERVAL or VALUESTORE_BACKGROUNDINTERVAL.
	outPushReplicationInterval int
	// outPushReplicationMsgs indicates how many outgoing push-replication
	// messages can be buffered before blocking on creating more. Defaults to
	// env VALUESTORE_OUTPUSHREPLICATIONMSGS or VALUESTORE_WORKERS*4.
	...
	// compactionInterval indicates how often compaction will run. Defaults to
	// env VALUESTORE_COMPACTIONINTERVAL or VALUESTORE_BACKGROUNDINTERVAL.
...
func resolveConfig(opts ...func(*config)) *config {
	...
	cfg.outPullReplicationMsgs = cfg.workers * 4
	...
	cfg.outPushReplicationMsgs = cfg.workers * 4
...
// starts of background passes (for example, discarding expired tombstones
// [deletion markers]). If set to 60 seconds and the passes take 10 seconds to
// run, they will wait 50 seconds (with a small amount of randomization)
// between the stop of one run and the start of the next. This is really just
// meant to keep nearly empty structures from using a lot of resources doing
// nearly nothing. Normally, you'd want your background passes to be running
// constantly so that they are as fast as possible and the load constant. The
// default of 60 seconds is almost always fine. Defaults to env
// VALUESTORE_BACKGROUNDINTERVAL or 60.
