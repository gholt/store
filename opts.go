...
// will also be written here unless overridden with OptPathTOC. Defaults to the
...
// OptMsgCap indicates the maximum bytes for outgoing messages. Defaults to
// 16,777,216 bytes.
...
// OptTombstoneDiscardInterval overrides the OptBackgroundInterval value just
// for discard passes (discarding expired tombstones [deletion markers]).
...
// messages can be processed at the same time. Defaults to OptWorkers.
...
// an outgoing pull replication pass. Defaults to OptWorkers.
...
// OptOutPullReplicationInterval overrides the OptBackgroundInterval value just
...
// OptOutPullReplicationWorkers * 4.
...
// memory usage. Defaults to 1,000,000.
...
// N-factor, affects memory usage. Defaults to 0.001.
...
// an outgoing push replication pass. Defaults to OptWorkers.
...
// OptOutPushReplicationInterval overrides the OptBackgroundInterval value just
...
// messages can be buffered before blocking on creating more. Defaults to
// OptOutPushReplicationWorkers * 4.
...
// OptValueCap indicates the maximum number of bytes any given value may be.
...
// per values file for reading. Defaults to OptWorkers.
...
// processed at the same time. Defaults to OptWorkers.
...
// buffered before dropping additional ones. Defaults to OptInBulkSetWorkers *
// 4.
...
// OptOutBulkSetMsgs indicates how many outgoing bulk-set messages can be
...
// messages. Defaults to OptMsgCap.
...
// can be processed at the same time. Defaults to OptWorkers.
...
// buffered before dropping additional ones. Defaults to OptInBulkSetAckWorkers
// * 4.
...
// bulk-set-ack messages. Defaults to OptMsgCap.
...
// OptCompactionInterval overrides the OptBackgroundInterval value just for
// compaction passes.
...
// it is compacted. Defaults to 0.10 (10%).
...
// compaction. Defaults to OptWorkers.
