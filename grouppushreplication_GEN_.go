...
func (vs *DefaultGroupStore) pushReplicationConfig(cfg *GroupStoreConfig) {
	...
	if vs.msgRing != nil {
		vs.pushReplicationState.outMsgChan = make(chan *groupPullReplicationMsg, cfg.OutPushReplicationMsgs)
	}
...
func (vs *DefaultGroupStore) pushReplicationLaunch() {
...
func (vs *DefaultGroupStore) DisableOutPushReplication() {
...
func (vs *DefaultGroupStore) EnableOutPushReplication() {
	c := make(chan struct{}, 1)
	vs.pushReplicationState.outNotifyChan <- &backgroundNotification{
		enable:   true,
		doneChan: c,
...
func (vs *DefaultGroupStore) OutPushReplicationPass() {
...
func (vs *DefaultGroupStore) outPushReplicationLauncher() {
	var enabled bool
