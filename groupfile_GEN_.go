...
func (vf *groupFile) timestampnano() int64 {
	return vf.bts
}
...
func (vf *groupFile) write(vm *groupMem) {
	if vm == nil {
		return
	}
	vm.vfID = vf.id
